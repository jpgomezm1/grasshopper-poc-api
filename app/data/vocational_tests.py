...
VOCATIONAL_TESTS = [
    {
        ...
        "description": "Descubre tus intereses profesionales a traves de las 6 categorias Holland: Realista, Investigador, Artistico, Social, Emprendedor y Convencional.",
    ...
    # =====================================================================
    {
        ...
        "shortName": "iStrong",
        "description": "Profundiza en tus intereses profesionales mediante 12 escalas tematicas agrupadas en 6 areas de interes profesional. Te ayuda a entender no solo en que area encajas sino que actividades especificas dentro de ella te motivan mas.",
